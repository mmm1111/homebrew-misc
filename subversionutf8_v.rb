class Subversionutf8 < Formula
  ...
  resource "serf" do
    url "https://archive.apache.org/dist/serf/serf-1.3.9.tar.bz2", :using => :curl
  ...
  if build.with? "unicode-path"
    patch :p0 do
      url "https://raw.githubusercontent.com/hafuri/misc/master/svn_1.8.x_darwin_unicode_precomp.patch"
    end
  end
